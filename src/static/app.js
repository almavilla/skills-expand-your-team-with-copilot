document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    // Apply client-side filtering - this handles category and difficulty filters, search, plus weekend filter
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      // Apply difficulty filter; "All" shows activities open to all levels.
      if (
